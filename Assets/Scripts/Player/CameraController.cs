...
public class CameraController : MonoBehaviour
{
    ...
    void RotateMainCamera()
    {
        ...
        // guns.transform.localRotation = Quaternion.AngleAxis(-currentLook.y, Vector3.right);
        // guns.transform.localEulerAngles = new Vector3(transform.localEulerAngles.x, transform.localEulerAngles.y, curTilt);
        // guns.transform.root.transform.localRotation = Quaternion.Euler(0, currentLook.x, 0);
    }
